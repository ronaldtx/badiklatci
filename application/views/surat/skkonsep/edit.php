...
<div class="page-header position-relative">
    <h1>
        Edit Surat Keluar Dengan Konsep
    </h1>
</div>              
<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>surat/skkonsep/savenew" enctype="multipart/form-data">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" id="nosurat_left" readonly="true" value="<?php echo substr($surat->no_surat_keluar, 0, 6) ?>" name="nosurat_left" placeholder="No. Surat Keluar" />
            <input type="text" id="nosurat_right" required value="<?php echo substr($surat->no_surat_keluar, 6) ?>" name="nosurat_right" placeholder="No. Surat Keluar" />
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <div class="row-fluid input-append">
                <input class="date-picker" value="<?php echo displaytgl($surat->tgl_surat_keluar) ?>" id="tglsuratkeluar" name="tglsuratkeluar" type="text" data-date-format="dd-mm-yyyy" />
                <span class="add-on">
                    <i class="icon-calendar"></i>
                </span>
            </div>

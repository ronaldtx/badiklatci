...
<div class="row-fluid">
    <form id="formlist" class="form-horizontal" method="post" action="<?php echo base_url(); ?>surat/konsep" enctype="multipart/form-data">
                ...
                <tr>
                    ...
                    <td class="td-actions">
                        <div class="hidden-phone visible-desktop action-buttons">
                            ...
                            <a class="green" href="<?php echo base_url(); ?>surat/skkonsep/edit<?php echo $link;?>">

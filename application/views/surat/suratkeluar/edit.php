...
<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>surat/suratkeluar/saveedit" enctype="multipart/form-data">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <input type="text" id="nosurat_right" readonly="true" required value="<?php echo substr($surat->no_surat_keluar, 6) ?>" name="nosurat_right" placeholder="No. Surat Keluar" />
        </div>
    </div>
    <div class="control-group">
